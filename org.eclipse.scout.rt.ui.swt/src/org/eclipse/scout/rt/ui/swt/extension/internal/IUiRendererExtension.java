...
/**
 * <h3>IUiRendererExtension</h3> The extension bean defining a form field
 ...
 * <ul>
 * <li>
 *      {@link IUiRendererExtension#SCOPE_DEFAULT} to indicate this extension to be the default implementation. Is
 * usually used of external component providers (e.g. a PhotoShopField).</li>
 * <li>
 *      {@link IUiRendererExtension#SCOPE_GLOBAL} to indicate this extension to have a global scope (whole eclipse).
 * Global defined extensions overwrite the default implementation.</li>
 * <li>
 *      {@link IUiRendererExtension#SCOPE_LOCAL} to indicate this extension to have local scope. Local defined extensions
 ...
 */
public interface IUiRendererExtension {
  int SCOPE_DEFAULT = 0;
  int SCOPE_GLOBAL = 1;
  int SCOPE_LOCAL = 2;
   ...
   * <ul>
   * <li>
   *      {@link IUiRendererExtension#SCOPE_DEFAULT} to indicate this extension to be the default implementation.</li>
   * <li>
   *      {@link IUiRendererExtension#SCOPE_GLOBAL} to indicate this extension to have a global scope (whole eclipse).
   * Global defined extensions overwrite the default implementation.</li>
   * <li>
   *      {@link IUiRendererExtension#SCOPE_LOCAL} to indicate this extension to have local scope. Local defined
   ...
   * </ul>
   * 
   * @return one of {@link IUiRendererExtension#SCOPE_DEFAULT}, {@link IUiRendererExtension#SCOPE_GLOBAL},
   *         {@link IUiRendererExtension#SCOPE_LOCAL}
   */
  int getScope();
